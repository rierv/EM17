...
public class SuccessFragment extends Fragment {
    ...
    private TextView mTicketHolderNameTextView;
    private TextView mTicketCodeTextView;
    ...
    public static SuccessFragment newInstance(String ticketCode, String ticketHolderName) {
        SuccessFragment fragment = new SuccessFragment();
        fragment.ticketCode = ticketCode;
        fragment.ticketHolderName = ticketHolderName;
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mTicketHolderNameTextView = view.findViewById(R.id.ticketHolderNameTextView);
        mTicketHolderNameTextView.setText(getText(R.string.holder) + " " + ticketHolderName);

        mTicketCodeTextView = view.findViewById(R.id.ticketCodeTextView);
        mTicketCodeTextView.setText(getText(R.string.ticketCode) + " " + ticketCode);
